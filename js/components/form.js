...
const form = (selectFields) => {
  const form = `
    <form class="max-w-md mx-auto">
      ...
      <div class="relative z-0 w-full mb-8 group">
        <label for="category" class="block mb-2 text-sm text-blue-800 dark:text-white">Escolha uma categoria</label>
      ...
      <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Adicionar</button>
